...
public class LogBuffer {
     ...
     */
    public synchronized void add(String log, String level, String pluginName, long timestamp,String transactionID,String playerName,String uuid,String serverName) {
        buffer.add(new LogEntry(log, level, pluginName, timestamp,transactionID,playerName,uuid,serverName));
    }
